...
public class GrabStuff : MonoBehaviour
{
	...
	*/
	...
	public string grabButton;//Reference to input manager
	public string placeButton;//Button to place a camera on the wall and ceiling (maybe)
	...
	{
		if (holdingObject) {
			Debug.Log ("Holding object: " + otherObject);
